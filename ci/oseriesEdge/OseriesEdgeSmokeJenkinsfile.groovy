    ...
    stage('smoke-test') {
        container('mvn3-jdk11') {
            try {
                sh """
          cd ConnectorQuality
          mvn test -Dgroups=oseriesEdge-smoke -e -Dservices.webdriver.downloadDirectoryPath=/home/jenkins/agent/ConnectorQuality/target/ -Dservices.webdriver.provisioned=true -Dservices.webdriver.headless=true
       """
            } catch (e) {
