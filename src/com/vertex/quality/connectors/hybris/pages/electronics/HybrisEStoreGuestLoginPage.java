 ...
 */
public class HybrisEStoreGuestLoginPage extends HybrisBasePage
{
	public HybrisEStoreGuestLoginPage( WebDriver driver )
	{
		super(driver);
	}
	 ...
	 */
	public HybrisEStoreCheckOutPage checkoutAsGuest( )
	{
		click.clickElement(CHECK_OUT_AS_GUEST_BUTTON);
		final HybrisEStoreCheckOutPage checkoutpage = initializePageObject(HybrisEStoreCheckOutPage.class);
		return checkoutpage;
	}
}
