 ...
 * Invoice page actions/methods
 */
public class AcumaticaInvoicesPage extends AcumaticaBasePage
{
	...
	protected By FINANANCE_DETAILS_BRANCH = By.id("ctl00_phG_tab_t4_form2_edBranchID_text");
	protected By CUSTOMER_TAX_ZONE = By.id("ctl00_phG_tab_t4_form2_edTaxZoneID_text");
	protected By OVERRIDE_ADDRESS_CHECK_BOX = By.id("ctl00_phG_tab_t6_formA_chkOverrideAddress");
	protected By ADDRESS_LINE_1 = By.id("ctl00_phG_tab_t6_formA_edAddressLine1");
	protected By ADDRESS_LINE_2 = By.id("ctl00_phG_tab_t6_formA_edAddressLine2");
	protected By CITY = By.id("ctl00_phG_tab_t6_formA_edCity");
	protected By COUNTRY = By.id("ctl00_phG_tab_t6_formA_edCountryID_text");
	protected By STATE = By.id("ctl00_phG_tab_t6_formA_edState_text");
	protected By ZIPCODE = By.id("ctl00_phG_tab_t6_formA_edPostalCode");

	public AcumaticaInvoicesPage( WebDriver driver )
	{
		super(driver);
	}
