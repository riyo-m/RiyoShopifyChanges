...
public enum OSeriesData {
    ...
    O_SERIES_USER("kibo-qa-user"),
    O_SERIES_PASSWORD("kibo-qa-pwd"),

    // O-Series Login, Taxation & Cleansing URL(s)
    O_SERIES_URL("https://oseries9-final.vertexconnectors.com/oseries-ui"),
    O_SERIES_TAX_CALCULATION_URL("https://oseries9-final.vertexconnectors.com/vertex-ws/services/CalculateTax90?wsdl"),
    O_SERIES_ADDRESS_CLEANSING_URL("https://oseries9-final.vertexconnectors.com/vertex-ws/services/LookupTaxAreas90?wsdl"),
    ...
    // Kibo connector's version(s)
    KIBO_CONNECTOR_VERSION_1_0_0("1.0.0"),
