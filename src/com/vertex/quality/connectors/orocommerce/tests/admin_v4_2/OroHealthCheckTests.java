...
public class OroHealthCheckTests extends OroStoreFrontBaseTest {
    ...
    /**
     * COROCOM-1026 Oro 4.2 - Test Case - Perform a Healthcheck - Invalid address URL
     */
    ...
    /**
     * COROCOM-1028 Oro 4.2 - Test Case - Perform a Healthcheck - valid address and tax calc
     */
    @Test(groups = {"oroSmoke_v4_2"})
