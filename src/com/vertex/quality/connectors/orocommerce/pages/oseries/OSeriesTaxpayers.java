package com.vertex.quality.connectors.orocommerce.pages.oseries;
...
public class OSeriesTaxpayers extends VertexPage {
    ...
    protected By cancelButton = By.xpath(".//a[text()='CANCEL']");
    ...
    public void saveSettings() {
        WebElement save = wait.waitForElementEnabled(saveButton);
