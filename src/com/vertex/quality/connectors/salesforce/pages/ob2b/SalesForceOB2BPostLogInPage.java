 ...
 * @author
 */
public class SalesForceOB2BPostLogInPage extends SalesForceBasePage
{
	...
	public SalesForceOB2BPostLogInPage( WebDriver driver )
	{
		super(driver);
	}
	...
	/**
	 * Check if Sales force OB2B loaded in Lighting view , If Yes switch to Classic
	 * view
	 */
	public void checkAndSwitchClassicView( )
	{
		...
		{
			VertexLogger.log("Salesforce OB2B is in Classic View.", SalesForceLogInPage.class);
		}
	 ...
	 * @param appName
	 */
	public void switchToOB2BAppMenu( String appName )
	{
		waitForPageLoad();
		wait.waitForElementDisplayed(SELECTED_APP_MENU);
	 ...
	 * @param tabName
	 */
	public void clickOB2BPageTab( String tabName )
	{
		String tabLocator = String.format("//a[starts-with(@title,'%s Tab')]", tabName);
		wait.waitForElementDisplayed(By.xpath(tabLocator));
		click.clickElement(By.xpath(tabLocator));
		waitForPageLoad();
	}
