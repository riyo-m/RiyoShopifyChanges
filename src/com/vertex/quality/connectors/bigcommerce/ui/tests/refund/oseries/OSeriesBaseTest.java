...
public abstract class OSeriesBaseTest extends VertexUIBaseTest<OSeriesSignOnPage>
{
	...
	protected String OSERIES_ADMIN_USERNAME;
	protected String OSERIES_ADMIN_PASSWORD;
	...
	private void initializeVariables( )
	{
		try
		{
			...
			OSERIES_ADMIN_USERNAME = readCredentials.getProperty("TEST.CREDENTIALS.OSERIES.ADMIN.USERNAME");
			OSERIES_ADMIN_PASSWORD = readCredentials.getProperty("TEST.CREDENTIALS.OSERIES.ADMIN.PASSWORD");
