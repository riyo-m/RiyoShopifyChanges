 ...
 * @author vivek-kumar
 */
public class BigCommerceAPIItalyInvoiceVATTests extends BigCommerceAPIBaseTest
{
    /**
     * sends commit request and validate VAT rate as per Ship To Address.
     */
    @Test(groups = { "bigCommerce_vat","bigCommerce_regression" })
    public void commitAndItalyEUToEUVATTest( )
    {
        ...
        BigCommerceRequestDocument doc1 = apiUtil.buildDocument(document1Id,
                BigCommerceTestDataAddress.ITALY_ADDRESS, BigCommerceTestDataAddress.ITALY_ADDRESS,
                false, shirt);
     ...
     */
    @Test(groups = { "bigCommerce_vat","bigCommerce_regression" })
    public void commitAndItalyUSToEUVATTest( )
    {
        final String rate = "0.0";
        BigCommerceRequestItem shirt = apiUtil.buildItem(standardLowPriceAmount, false, defaultQuantity, item1Id);

        BigCommerceRequestDocument doc1 = apiUtil.buildDocument(document1Id,
                BigCommerceTestDataAddress.ITALY_ADDRESS, BigCommerceTestDataAddress.US_CA_ADDRESS,
                false, shirt);
     ...
     */
    @Test(groups = { "bigCommerce_vat","bigCommerce_regression" })
    public void commitAndItalyEUToUSVATTest( )
    {
        ...
        BigCommerceRequestDocument doc1 = apiUtil.buildDocument(document1Id,
                BigCommerceTestDataAddress.US_CA_ADDRESS, BigCommerceTestDataAddress.ITALY_ADDRESS,
                false, shirt);
