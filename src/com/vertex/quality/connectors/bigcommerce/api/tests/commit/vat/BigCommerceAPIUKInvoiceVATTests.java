...
public class BigCommerceAPIUKInvoiceVATTests extends BigCommerceAPIBaseTest {
    ...
    public void commitAndUKEUToEUVATTest( )
    {
        ...
        BigCommerceRequestDocument doc1 = apiUtil.buildDocument(document1Id,
                BigCommerceTestDataAddress.UNITED_KINGDOM_ADDRESS, BigCommerceTestDataAddress.UNITED_KINGDOM_ADDRESS,
                false, shirt);
     ...
     */
    @Test(groups = { "bigCommerce_vat","bigCommerce_regression" })
    public void commitAndUKUSToEUVATTest( )
    {
        final String rate = "0.0";
        BigCommerceRequestItem shirt = apiUtil.buildItem(standardLowPriceAmount, false, defaultQuantity, item1Id);

        BigCommerceRequestDocument doc1 = apiUtil.buildDocument(document1Id,
                BigCommerceTestDataAddress.UNITED_KINGDOM_ADDRESS, BigCommerceTestDataAddress.US_CA_ADDRESS,
                false, shirt);
     ...
     */
    @Test(groups = { "bigCommerce_vat","bigCommerce_regression" })
    public void commitAndUKEUToUSVATTest( )
    {
        ...
        BigCommerceRequestDocument doc1 = apiUtil.buildDocument(document1Id,
                BigCommerceTestDataAddress.US_CA_ADDRESS, BigCommerceTestDataAddress.UNITED_KINGDOM_ADDRESS,
                false, shirt);
