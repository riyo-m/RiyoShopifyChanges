 ...
 * @author vivek-kumar
 */
public class BigCommerceAPIGreekInvoiceVATTests extends BigCommerceAPIBaseTest
{
    /**
     * sends commit request and validate VAT rate as per Ship To Address.
     */
    @Test(groups = { "bigCommerce_vat","bigCommerce_regression" })
    public void commitAndGreekEUToEUVATTest( )
    {
        final String rate = "0.24";
        ...
        BigCommerceRequestDocument doc1 = apiUtil.buildDocument(document1Id,
                BigCommerceTestDataAddress.GREECE_THESSALONKIKI_ADDRESS, BigCommerceTestDataAddress.GREECE_THESSALONKIKI_ADDRESS,
                false, shirt);
     ...
     */
    @Test(groups = { "bigCommerce_vat","bigCommerce_regression" })
    public void commitAndGreekUSToEUVATTest( )
    {
        final String rate = "0.0";
        BigCommerceRequestItem shirt = apiUtil.buildItem(standardLowPriceAmount, false, defaultQuantity, item1Id);

        BigCommerceRequestDocument doc1 = apiUtil.buildDocument(document1Id,
                BigCommerceTestDataAddress.GREECE_THESSALONKIKI_ADDRESS, BigCommerceTestDataAddress.US_CA_ADDRESS,
                false, shirt);
    ...
    public void commitAndBelgiumEUToUSVATTest( )
    {
        ...
        BigCommerceRequestDocument doc1 = apiUtil.buildDocument(document1Id,
                BigCommerceTestDataAddress.US_CA_ADDRESS, BigCommerceTestDataAddress.GREECE_THESSALONKIKI_ADDRESS,
                false, shirt);
