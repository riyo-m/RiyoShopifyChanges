 ...
 * @author vivek-kumar
 */
public class BigCommerceAPIGermanyInvoiceVATTests extends BigCommerceAPIBaseTest
{
    /**
     * sends commit request and validate VAT rate as per Ship To Address.
     */
    @Test(groups = { "bigCommerce_vat","bigCommerce_regression" })
    public void commitAndGermanyEUToEUVATTest( )
    {
        final String rate = "0.19";
        ...
        BigCommerceRequestDocument doc1 = apiUtil.buildDocument(document1Id,
                BigCommerceTestDataAddress.GERMANY_BERLIN_ADDRESS, BigCommerceTestDataAddress.GERMANY_BERLIN_ADDRESS,
                false, shirt);
     ...
     */
    @Test(groups = { "bigCommerce_vat","bigCommerce_regression" })
    public void commitAndGermanyUSToEUVATTest( )
    {
        final String rate = "0.0";
        BigCommerceRequestItem shirt = apiUtil.buildItem(standardLowPriceAmount, false, defaultQuantity, item1Id);

        BigCommerceRequestDocument doc1 = apiUtil.buildDocument(document1Id,
                BigCommerceTestDataAddress.GERMANY_BERLIN_ADDRESS, BigCommerceTestDataAddress.US_CA_ADDRESS,
                false, shirt);
     ...
     */
    @Test(groups = { "bigCommerce_vat","bigCommerce_regression" })
    public void commitAndGermanyEUToUSVATTest( )
    {
        ...
        BigCommerceRequestDocument doc1 = apiUtil.buildDocument(document1Id,
                BigCommerceTestDataAddress.US_CA_ADDRESS, BigCommerceTestDataAddress.GERMANY_BERLIN_ADDRESS,
                false, shirt);
