 ...
 * @author vivek-kumar
 */
public class BigCommerceAPINetherlandsInvoiceVATTests extends BigCommerceAPIBaseTest
{
    /**
     * sends commit request and validate VAT rate as per Ship To Address.
     */
    @Test(groups = { "bigCommerce_vat","bigCommerce_regression" })
    public void commitAndNetherlandsEUToEUVATTest( )
    {
        final String rate = "0.21";
        ...
        BigCommerceRequestDocument doc1 = apiUtil.buildDocument(document1Id,
                BigCommerceTestDataAddress.NETHERLANDS_ADDRESS, BigCommerceTestDataAddress.NETHERLANDS_ADDRESS,
                false, shirt);
     ...
     */
    @Test(groups = { "bigCommerce_vat","bigCommerce_regression" })
    public void commitAndNetherlandsUSToEUVATTest( )
    {
        final String rate = "0.0";
        BigCommerceRequestItem shirt = apiUtil.buildItem(standardLowPriceAmount, false, defaultQuantity, item1Id);

        BigCommerceRequestDocument doc1 = apiUtil.buildDocument(document1Id,
                BigCommerceTestDataAddress.NETHERLANDS_ADDRESS, BigCommerceTestDataAddress.US_CA_ADDRESS,
                false, shirt);
     ...
     */
    @Test(groups = { "bigCommerce_vat","bigCommerce_regression" })
    public void commitAndNetherlandsEUToUSVATTest( )
    {
        ...
        BigCommerceRequestDocument doc1 = apiUtil.buildDocument(document1Id,
                BigCommerceTestDataAddress.US_CA_ADDRESS, BigCommerceTestDataAddress.NETHERLANDS_ADDRESS,
                false, shirt);
