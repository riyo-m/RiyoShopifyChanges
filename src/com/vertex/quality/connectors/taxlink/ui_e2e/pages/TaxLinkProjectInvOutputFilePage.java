...
public class TaxLinkProjectInvOutputFilePage extends TaxLinkBasePage
{
	public TaxLinkProjectInvOutputFilePage( final WebDriver driver ) throws IOException
	{
		super(driver);
	...
	public boolean verifyTitleProjectRulesPage( )
	{
		...
		if ( rulesMappingTitle.equalsIgnoreCase(InventoryRulesMapping.INVENTORY_RULES_MAPPING.headerProjectOutputPage) )
		{
			titleFlag = true;
		}
		return titleFlag;
	 ...
	 * @return String
	 */
	public String addAndVerifyInvProjectRule( String functionValue, String conditionSetValue, String invSrcVal,
		String invTargetVal )
	{
