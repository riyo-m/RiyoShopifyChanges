...
public class M2AdminCreditMemoPage extends MagentoAdminPage {
    ...
    protected By adjustmentRefund = By.name("creditmemo[adjustment_negative]");
    ...
    protected By totalRefunded = By.xpath("//*[contains(text(),'Total Refunded')]//following::span[1]");
     ...
     * Do partial refund
     *
     * @param refundItem Items which should be returned
     * @param qty        Quantity
     */
     ...
     * clicks the Refund Offline button on button right corner of page
     *
     * @param qty1         Quantity for product 1
     * @param qty2         Quantity for product 2
     * @param qty3         Quantity for product 3
     * @param adjustRefund Refund value
     * @return the order view info page
     */
    public M2AdminOrderViewInfoPage addAdjustmentRefund(String qty1, String qty2, String qty3, String adjustRefund) {
        ...
        WebElement adjustFeeText = wait.waitForElementEnabled(adjustmentRefund);
