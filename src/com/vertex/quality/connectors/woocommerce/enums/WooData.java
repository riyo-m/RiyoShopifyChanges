package com.vertex.quality.connectors.woocommerce.enums;
...
public enum WooData {
    ...
    DE_BERLIN_10696(new String[]{"Germany", "Oranienstraße 138", "Berlin", "Berlin", "10969"}),
    ...
    PRODUCT_BEANIE("Beanie with Logo"),
    ...
    ADDRESS_CLEANSING_NO_ZIP_MSG("Do you want to change your current address for a suggestion?\n" +
            "Current Address:\n" +
            "2955 Market St.\n" +
            "Philadelphia, PA empty\n" +
            "\n" +
            "Suggested Address:\n" +
            "2955 Market St\n" +
            "Philadelphia, PA 19104-2828"),
    ADDRESS_CLEANSING_INVALID_CITY_ZIP_MSG("Do you want to change your current address for a suggestion?\n" +
            "Current Address:\n" +
            "2955 Market St.\n" +
            "Chester, PA 19104\n" +
            "\n" +
            ...
            "2955 Market St\n" +
            "Philadelphia, PA 19104-2828"),
    ADDRESS_CLEANSING_BLANK_ZIP_MSG("Do you want to change your current address for a suggestion?\n" +
            "Current Address:\n" +
            "1270 York Rd\n" +
            "Gettysburg, PA blank\n" +
            "\n" +
            "Suggested Address:\n" +
            "1270 York Rd\n" +
            "Gettysburg, PA 17325-7562"),
    ADDRESS_CLEANSING_INVALID_STATE_ZIP_MSG("Do you want to change your current address for a suggestion?\n" +
            "Current Address:\n" +
            "2955 Market St.\n" +
            "Philadelphia, DE 19104\n" +
            "\n" +
            "Suggested Address:\n" +
            "2955 Market St\n" +
            "Philadelphia, PA 19104-2828"),
    ADDRESS_CLEANSING_NULL_ZIP_MSG("Do you want to change your current address for a suggestion?\n" +
            "Current Address:\n" +
            "2955 Market St.\n" +
            ...
            "2955 Market St\n" +
            "Philadelphia, PA 19104-2828"),
    ADDRESS_CLEANSING_MSG_INVALID_ZIP_MSG("Do you want to change your current address for a suggestion?\n" +
            "Current Address:\n" +
            "1270 York Rd\n" +
            "Gettysburg, PA 99999\n" +
            "\n" +
