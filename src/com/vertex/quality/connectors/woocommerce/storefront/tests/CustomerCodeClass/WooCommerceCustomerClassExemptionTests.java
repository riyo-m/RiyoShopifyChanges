 ...
 * @author vivek.kumar
 */
public class WooCommerceCustomerClassExemptionTests extends WooCommerceBaseTest {
    ...
    /**
     * CWOO-370
     * WOO - Test Case - Create Sales order with Customer Class Exemption.
     */
    @Test(groups = "woo_regression")
    public void wooCommerceCustomerClassExemptionTest() {
        ...
        adminLoginPage.loginAsUser(WooCommerceData.EXEMPT_CUSTOMER_CLASS_USERNAME.data, WooCommerceData.EXEMPT_CUSTOMER_CLASS_PASSWORD.data);
