 ...
 * @author vivek.kumar
 */
public class WooCommerceProductClassExemptionTests extends WooCommerceBaseTest {
    protected String totalString;

    /**
     * CWOO-367
     * WOO - Test Case - Create Sales order with Product Class Exemption.
     */
    @Test(groups = "woo_regression")
    public void wooCommerceProductClassExemptionTest() {
        WooCommerceAdminHomePage homePage = new WooCommerceAdminHomePage(driver);
        homePage.setProductClass(WooCommerceData.PRODUCT_CLASS.data);
        loadStoreFrontPage();
