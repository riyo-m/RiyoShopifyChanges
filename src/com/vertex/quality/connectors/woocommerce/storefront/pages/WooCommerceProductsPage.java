...
import com.vertex.quality.connectors.woocommerce.storefront.pages.base.WooCommercePreCheckoutBasePage;
...
public class WooCommerceProductsPage extends WooCommercePreCheckoutBasePage {
    ...
    protected final By viewCart = By.xpath("//a[contains(text(),'View cart')]");
