 ...
 * @author Shivam.Soni
 */
public class ShopifySpecialFeeInvoiceTests extends ShopifyUIBaseTest {
    ...
    /**
     * XRAYSHOP-56 Shopify - Invoice - Test Case - Validate retail delivery fee for CO address
     */
    @Test(groups = {"shopify_regression", "shopify_invoice"})
    public void taxInvoiceSpecialFeeCOTest() {
        // Load storefront
        loadShopifyStore();
        ...
        assertEquals(tax, storePaymentPage.calculatePercentBasedTaxBeforeOrderPlace(8.2) + ShopifyDataUI.AdditionalFees.CO_RDF.value);
