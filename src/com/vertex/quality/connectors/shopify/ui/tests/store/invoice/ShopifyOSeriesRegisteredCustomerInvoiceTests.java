 ...
 * @author Shivam.Soni
 */
public class ShopifyOSeriesRegisteredCustomerInvoiceTests extends ShopifyUIBaseTest {
    ...
    /**
     * XRAYSHOP-49 Shopify - Invoice - Test Case - Create Sale Order where the Customer is registered in O Series and the Financial System
     */
    @Test(groups = {"shopify_regression", "shopify_invoice"})
    public void taxInvoiceWithOSRegisteredCustomerTest() {
        // Load storefront
        loadShopifyStore();
        ...
        assertEquals(tax, storePaymentPage.calculatePercentBasedTaxBeforeOrderPlace(7.45));
