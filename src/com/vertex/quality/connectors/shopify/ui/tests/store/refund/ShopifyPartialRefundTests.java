 ...
 * @author Shivam.Soni
 */
public class ShopifyPartialRefundTests extends ShopifyUIBaseTest {
    ...
    /**
     * XRAYSHOP-60 Shopify - Return - Test Case - Return Sales order - partial quantity returned
     */
    @Test(groups = {"shopify_regression", "shopify_refund"})
    public void taxInvoicePartialQtyRefundTest() {
        ...
        assertEquals(refundTax, adminRefundPage.calculatePercentBasedTax(expectedTaxPercent));
    ...
    /**
     * XRAYSHOP-59 Shopify - Return - Test Case - Return Sales order - partial order with shipping
     */
    @Test(groups = {"shopify_regression", "shopify_refund"})
    public void taxInvoicePartialOrderRefundTest() {
