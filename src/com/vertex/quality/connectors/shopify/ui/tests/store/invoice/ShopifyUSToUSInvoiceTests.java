 ...
 * @author Shivam.Soni
 */
public class ShopifyUSToUSInvoiceTests extends ShopifyUIBaseTest {
    ...
    /**
     * XRAYSHOP-43 Shopify - Invoice - Test Case -Create Sales Order with Modified Origin State
     */
    @Test(groups = {"shopify_regression", "shopify_invoice"})
    public void taxInvoiceWithModifiedOriginStateTest() {
        // Load storefront
        loadShopifyStore();
        ...
        assertEquals(tax, storePaymentPage.calculatePercentBasedTaxBeforeOrderPlace(9.5));
    ...
    /**
     * XRAYSHOP-44 Shopify - Invoice - Test Case -Create Sales Order with no State Tax, locally administered
     */
    @Test(groups = {"shopify_regression", "shopify_invoice"})
    public void taxInvoiceWithLocallyAdministeredStateTaxTest() {
        // Load storefront
        loadShopifyStore();
        ...
        storePaymentPage = storeShippingInfoPage.clickContinuePayment();
        tax = storePaymentPage.getTaxFromUIBeforeOrderPlace();
        assertEquals(tax, storePaymentPage.calculatePercentBasedTaxBeforeOrderPlace(5));
        storePaymentPage.enterCreditCardDetails();
        orderConfirmationPage = storePaymentPage.clickPayNow();
        uiOrderNo = orderConfirmationPage.getOrderNoFromUI();
        VertexLogger.log(uiOrderNo);
    ...
    /**
     * XRAYSHOP-45 Shopify - Invoice - Test Case -Create Sales Order with no State Tax
     */
    @Test(groups = {"shopify_regression", "shopify_invoice"})
    public void taxInvoiceWithNoStateTaxTest() {
        // Load storefront
        loadShopifyStore();
        ...
        adminOrderDetailsPage = adminOrdersPage.openOrderDetail(uiOrderNo);
        assertTrue(adminOrderDetailsPage.verifyOrderStatus(uiOrderNo, ShopifyDataUI.ShopifyOrderAndPaymentStatus.FULFILLED.text));
        assertFalse(adminOrderDetailsPage.isTaxPresentOnUI());
