...
public class InvoiceRefundStoreFront extends ShopifyUIBaseTest
{
...
//		loadShopifyAdmin();
		...
		System.out.println(adminTax);
		assertEquals(tax, adminTax);

		qoutationAdminOrderPage.getFulfilledDialog();

		quotationRefundPage = new InStoreFrontRefundPage(driver);
		quotationRefundPage.refundOrderPage("1");

		refundAmount = quotationRefundPage.verifyAmountAfterRefund();
		System.out.println(refundAmount);
		Thread.sleep(10000);
		assertEquals(refundAmount,0.0);
