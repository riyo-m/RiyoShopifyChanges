 ...
 * @author Shivam.Soni
 */
public class ShopifyDifferentBillShipAddressInvoiceTest extends ShopifyUIBaseTest {
    ...
    /**
     * XRAYSHOP-46 Shopify - Invoice - Test Case -Create Sales Order different ship and bill
     */
    @Test(groups = {"shopify_regression", "shopify_invoice"})
    public void taxInvoiceWithDifferentBillShipAddressTest() {
        // Load storefront
        loadShopifyStore();
