 ...
 * @author Shivam.Soni
 */
public class ShopifyCustomerExemptionInvoiceTests extends ShopifyUIBaseTest {
    ...
    /**
     * XRAYSHOP-50 Shopify - Invoice - Test Case - Create Sales order with Customer Exemption Certificate
     */
    @Test(groups = {"shopify_regression", "shopify_invoice"})
    public void vertexExemptionCertificateInvoiceTest() {
        // Load storefront
        loadShopifyStore();
    ...
    /**
     * XRAYSHOP-51 Shopify - Invoice - Test Case - Create Sales order with Customer Code Exemption
     */
    @Test(groups = {"shopify_regression", "shopify_invoice"})
    public void vertexCustomerCodeExemptionInvoiceTest() {
        // Load storefront
        loadShopifyStore();
    ...
    /**
     * XRAYSHOP-52 Shopify - Invoice - Test Case - Create Sales order with Shopify's exempted customer
     */
    @Test(groups = {"shopify_regression", "shopify_invoice"})
    public void shopifyExemptedCustomerInvoiceTest() {
        // Load storefront
        loadShopifyStore();
