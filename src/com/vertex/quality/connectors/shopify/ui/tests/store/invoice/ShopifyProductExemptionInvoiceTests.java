 ...
 * @author Shivam.Soni
 */
public class ShopifyProductExemptionInvoiceTests extends ShopifyUIBaseTest {
    ...
    /**
     * XRAYSHOP-85 Shopify - Invoice - Test Case - Create Sales order with Vertex's exempted product (Product Code)
     */
    @Test(groups = {"shopify_regression", "shopify_invoice"})
    public void vertexProductCodeTest() {
        // Load storefront
        loadShopifyStore();
    ...
    /**
     * XRAYSHOP-57 Shopify - Invoice - Test Case - Create Sales order with Shopify exempted product
     */
    @Test(groups = {"shopify_regression", "shopify_invoice"})
    public void shopifyExemptedProductTest() {
        // Load storefront
        loadShopifyStore();
