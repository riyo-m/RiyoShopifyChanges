 ...
 * @author Shivam.Soni
 */
public class ShopifyBulkQtyInvoiceTests extends ShopifyUIBaseTest {
    ...
    /**
     * XRAYSHOP-36 Shopify - Invoice - Test Case - Create Quotation with bulk quantities 10
     */
    @Test(groups = {"shopify_regression", "shopify_invoice"})
    public void taxInvoiceWithBulkQtyTest() {
        // Load storefront
        loadShopifyStore();
        ...
        // Update quantity
        storeCartPage.updateQuantity(ShopifyDataUI.Products.COLLECTION_SNOWBOARD_HYDROGEN.text, ShopifyDataUI.Quantities.QTY_10.text);
        ...
        storeShippingInfoPage.setShippingAddress(true, Address.Washington.country.fullName, Address.Washington.addressLine1,
                Address.Washington.city, Address.Washington.state.fullName, Address.Washington.zip5);
...
//        storePaymentPage = storeShippingInfoPage.clickContinuePayment();
        ...
        assertEquals(tax, storePaymentPage.calculatePercentBasedTaxBeforeOrderPlace(10.1));
