 ...
 * @author Shivam.Soni
 */
public class ShopifyDigitalGoodsInvoiceTests extends ShopifyUIBaseTest {
    ...
    /**
     * XRAYSHOP-54 Shopify - Invoice - Test Case -Create Sales Order with Digital Product
     */
    @Test(groups = {"shopify_regression", "shopify_invoice"})
    public void taxInvoiceWithDigitalGoodsOnlyTest() {
        // Load storefront
        loadShopifyStore();
    ...
    /**
     * XRAYSHOP-53 Shopify - Invoice - Test Case -Create Sales Order with Gift Card
     */
    @Test(groups = {"shopify_regression", "shopify_invoice"})
    public void taxInvoiceWithGiftCardOnlyTest() {
        // Load storefront
        loadShopifyStore();
        ...
        adminOrderDetailsPage = adminOrdersPage.openOrderDetail(uiOrderNo);
        assertTrue(adminOrderDetailsPage.verifyOrderStatus(uiOrderNo, ShopifyDataUI.ShopifyOrderAndPaymentStatus.FULFILLED.text));
        assertFalse(adminOrderDetailsPage.isTaxPresentOnUIBeforeOrderPlaceDigitalProducts());
    ...
    /**
     * XRAYSHOP-55 Shopify - Invoice - Test Case -Create Sales Order with Mixed Basket (Physical + Virtual products)
     */
    @Test(groups = {"shopify_regression", "shopify_invoice"})
    public void taxInvoiceWithMixedBasketTest() {
        ...
        adminOrderDetailsPage = adminOrdersPage.openOrderDetail(uiOrderNo);
        assertTrue(adminOrderDetailsPage.verifyOrderStatus(uiOrderNo, ShopifyDataUI.ShopifyOrderAndPaymentStatus.FULFILLED.text));
        assertEquals(taxWithoutDigitalProduct, adminOrderDetailsPage.getTaxFromUI());
