package com.vertex.quality.connectors.magento.storefront.components;
...
import com.vertex.quality.connectors.magento.storefront.pages.M2StorefrontGearPage;
...
public class StorefrontNavigationPanel extends VertexComponent
{
	...
	public void clearShoppingCartFromSC( )
	{
		...
		clickLogoButton();
		clearShoppingCart();
		/*List<WebElement> shoppingCartItems = wait.waitForAllElementsPresent(shoppingCartFullClass);
	...
	/**
	 * Opens the minicart via the popup and if it is not already empty,
	 * delete all items
