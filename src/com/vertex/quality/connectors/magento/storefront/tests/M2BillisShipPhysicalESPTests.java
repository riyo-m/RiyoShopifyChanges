...
/**
 * This Test Changes the value to ShippingTo Spain in admin config page and test the correct tax is displayed at
 * each stage of inputting an order in Magento Storefront as a customer same billing and shipping for a
 * Companion bundle products to an address in Spain
 *
 * @author alewis
 */
public class M2BillisShipPhysicalESPTests extends M2StorefrontBaseTest
{
	...
	protected String bundleURL = MagentoData.STOREFRONT_COMPANION_BUNDLE.data;
	String catrinaUsername = MagentoData.CATRINA_ARAGON.data;
	...
	{
		String correctExclSubtotalTax = "61.0";
		String correctInclSubtotalTax = "73.81";
		String correctSalesUseTax = "$12.81";
		String correctTotalTaxAmount = "$13.86";
		String correctExclTotalTax = "66.0";
		String correctInclTotalTax = "79.86";
		...
		//Changing the value of Use Vertex For Orders ShippingTo Field To Spain
		configVertexSetting.changeUseVertexForOrdersShippingToField("Spain");
	...
	protected M2StorefrontHomePage signInToStorefront( )
	{
		...
		loginPage.enterUsername(catrinaUsername);
	...
	protected M2StorefrontProductDetailsPage putInBundleProducts( )
	{
		...
		detailsPage.clickCustomizeAddToCartButton();
