 ...
 * @author alewis
 */
public class M2SFBillNotShipPhysicalTests extends M2StorefrontBaseTest
{
	...
	public void checkSubtotalTaxInPaymentPageExistingCustTest( )
	{
		...
		String slicedDifferenceSubtotal = String.format("%.4f", difference);

		clickLogoButton();
		clearShoppingCart();

		assertTrue(slicedDifferenceSubtotal.equals(MagentoData.CA_TAX_RATE.data));
	}
	...
	public void checkShippingTaxInPaymentPageExistingCustTest( )
	{
		...
		assertTrue(slicedShippingString.equals(MagentoData.CA_TAX_RATE_3.data));
	}
	...
	public void checkBlindTaxInPaymentPageExistingCustTest( )
	{
		...
		String slicedShippingString = String.format("%.3f", taxAppliedToShipping);

		clickLogoButton();
		clearShoppingCart();

		assertTrue(slicedSalesUseString.equals(MagentoData.CA_TAX_NUMBER.data));
		assertTrue(slicedShippingString.equals(MagentoData.CA_TAX_NUMBER.data));
	}
	...
	public void checkTotalTaxInPaymentPageExistingCustTest( )
	{
		...
		String slicedDifferenceString = String.format("%.4f", difference);

		clickLogoButton();
		clearShoppingCart();

		assertTrue(slicedDifferenceString.equals(MagentoData.CA_TAX_RATE.data));
	}
	...
	public void checkTaxOnOrderNumberPageTest( )
	{
		...
		String slicedString = String.format("%.4f", difference);
		...
		String slicedDifferenceSubtotal = String.format("%.4f", differenceSubtotal);

		clickLogoButton();
		clearShoppingCart();

		assertTrue(slicedString.equals(MagentoData.CA_TAX_RATE.data));
		assertTrue(slicedShippingString.equals(MagentoData.CA_EXEMPTION_RATE.data));
		assertTrue(slicedDifferenceSubtotal.equals(MagentoData.CA_TAX_RATE.data));
	}
	...
	protected M2StorefrontPaymentMethodPage navigateToPaymentMethodPage( )
	{
		...
		if (shoppingCartPage.verifyPopUpLogin()){
			...
			shoppingCartPage.popup.enterUserInfo(paUsername, passwordString);
