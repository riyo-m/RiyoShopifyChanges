 ...
 */
public class M2ACPhysicalOriginWithInvalidZipTests extends MagentoAdminBaseTest {
    ...
    /**
     * CMAGM2-828
     * Test case for physical origin with invalid zip.
     */
    @Test(groups = {"magento_regression"})
    public void physicalOriginAddressCleansingWithInvalidZipTest() {
