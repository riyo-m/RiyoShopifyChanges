 ...
 * @author Shivam.Soni
 */
public class M2ACPhysicalOriginWithCalcOfNullZipTests extends MagentoAdminBaseTest {
    ...
    /**
     * CMAGM2-1093
     * Test Case - Validate Sales Order with Address Cleansing No Zip
     */
    ...
    public void physicalOriginWithCalcOffNullZipTest() {
        ...
        billingAddress = createBillingAddress(MagentoData.US_SHIPPING_FIRST_NAME.data, MagentoData.US_SHIPPING_LAST_NAME.data, Address.Philadelphia.addressLine1,
                ...
                Address.Philadelphia.city, "NULL", MagentoData.US_SHIPPING_PHONE.data);
