...
/**
 * Ship To - Lithuania Tests
 *
 * @author Shivam.Soni
 */
public class M2SalesOrderLithuaniaVATTests extends MagentoAdminBaseTest {
    ...
    /**
     * CMAGM2-1176 Sales order Lithuania to Lithuania
     */
    @Test(groups = {"magento_regression"})
    public void checkTaxAmountInCreateNewOrderLTLTTest( )
    {
        setShippingOrigin(MagentoEUAddresses.LITHUANIA_ADDRESS.country, MagentoEUAddresses.LITHUANIA_ADDRESS.region, MagentoEUAddresses.LITHUANIA_ADDRESS.zip5, MagentoEUAddresses.LITHUANIA_ADDRESS.city, MagentoEUAddresses.LITHUANIA_ADDRESS.addressLine1);
        ...
        billingAddress = createBillingAddress(MagentoData.EU_SHIPPING_FIRST_NAME.data,
                MagentoData.EU_SHIPPING_LAST_NAME.data, MagentoEUAddresses.LITHUANIA_ADDRESS.addressLine1,
                MagentoEUAddresses.LITHUANIA_ADDRESS.country, MagentoEUAddresses.LITHUANIA_ADDRESS.region,
                MagentoEUAddresses.LITHUANIA_ADDRESS.city, MagentoEUAddresses.LITHUANIA_ADDRESS.zip5,
    ...
    /**
     * CMAGM2-1174 Sales order France to Lithuania
     */
    @Test(groups = {"magento_regression"})
    public void checkTaxAmountInCreateNewOrderEULTTest( )
    {
    ...
    /**
     * CMAGM2-1175 Sales order US to Lithuania
     */
    @Test(groups = {"magento_regression"})
    public void checkTaxAmountInCreateNewOrderUSLTTest( )
    {
