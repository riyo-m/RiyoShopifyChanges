 ...
 * @author vivek-kumar
 */
public class M2SalesOrderShippingTermDDPTests extends MagentoAdminBaseTest {
    ...
    /**
     * tests tax on bottom right of page in Create New Order Page for Shipping Terms DDP.
     * CMAGM2-951
     */
