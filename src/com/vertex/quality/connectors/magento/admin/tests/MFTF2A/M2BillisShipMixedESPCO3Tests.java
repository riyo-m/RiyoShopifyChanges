 ...
 * @author alewis
 */
public class M2BillisShipMixedESPCO3Tests extends MagentoAdminBaseTest {
    ...
    protected String SKU1 = "MH07-XS-Black";
    protected String SKU2 = "MT11-M-Blue";
    protected String SKU3 = "SPCM";
    protected String SKU4 = "AL-01";
    protected String SKU5 = "240-LV07";
    protected String customerID = "Catrina Aragon";
    protected String refundProductString = "Hero Hoodie-XS-Black";
    protected String qty = "0";

    String totalRefundedString = "$384.78";
    ...
    protected M2AdminCreateNewOrderPage addProductToSalesOrders() {
        ...
        newOrderPage.clickAddSKUButton();
        newOrderPage.enterSKUNumber(SKU3);
        newOrderPage.enterQty();
        newOrderPage.clickAddToOrderButton();
        ...
        newOrderPage.clickAddSKUButton();
        newOrderPage.enterSKUNumber(SKU4);
        newOrderPage.enterQty();
        newOrderPage.clickAddToOrderButton();
        ...
        newOrderPage.clickAddSKUButton();
        newOrderPage.enterSKUNumber(SKU5);
        newOrderPage.enterQty();
        newOrderPage.clickAddToOrderButton();
