 ...
 * @author vivek-kumar
 */
public class M2MultiLineSalesOrderDiscountShippingTests extends MagentoAdminBaseTest {
    ...
    public void checkCreateOrderDiscountTest() {
        ...
        newOrderPage = addMultipleLineProductDetails(MagentoData.ONE_OFF_SHIP.data);
