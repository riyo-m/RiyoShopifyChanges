...
/**
 * Ship To - Croatia Tests
 *
 * @author Shivam.Soni
 */
public class M2SalesOrderCroatiaVATTests extends MagentoAdminBaseTest {
    ...
    /**
     * CMAGM2-1152 Sales order Croatia to Croatia
     */
    @Test(groups = {"magento_regression"})
    public void checkTaxAmountInCreateNewOrderHRHRTest( )
    {
        setShippingOrigin(MagentoEUAddresses.CROATIA_ADDRESS.country, MagentoEUAddresses.CROATIA_ADDRESS.region, MagentoEUAddresses.CROATIA_ADDRESS.zip5, MagentoEUAddresses.CROATIA_ADDRESS.city, MagentoEUAddresses.CROATIA_ADDRESS.addressLine1);
        ...
        billingAddress = createBillingAddress(MagentoData.EU_SHIPPING_FIRST_NAME.data,
                MagentoData.EU_SHIPPING_LAST_NAME.data, MagentoEUAddresses.CROATIA_ADDRESS.addressLine1,
                MagentoEUAddresses.CROATIA_ADDRESS.country, MagentoEUAddresses.CROATIA_ADDRESS.region,
                MagentoEUAddresses.CROATIA_ADDRESS.city, MagentoEUAddresses.CROATIA_ADDRESS.zip5,
    ...
    /**
     * CMAGM2-1150 Sales order Germany to Croatia
     */
    @Test(groups = {"magento_regression"})
    public void checkTaxAmountInCreateNewOrderEUHRTest( )
    {
    ...
    /**
     * CMAGM2-1151 Sales order US to Croatia
     */
    @Test(groups = {"magento_regression"})
    public void checkTaxAmountInCreateNewOrderUSHRTest( )
    {
