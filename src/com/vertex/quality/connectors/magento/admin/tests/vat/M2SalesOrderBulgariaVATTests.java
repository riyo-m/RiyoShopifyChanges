...
/**
 * Ship To - Bulgaria Tests
 *
 * @author Shivam.Soni
 */
public class M2SalesOrderBulgariaVATTests extends MagentoAdminBaseTest {
    ...
    /**
     * CMAGM2-1147 Sales order Bulgaria to Bulgaria
     */
    @Test(groups = {"magento_regression"})
    public void checkTaxAmountInCreateNewOrderBGBGTest( )
    {
        setShippingOrigin(MagentoEUAddresses.BULGARIA_ADDRESS.country, MagentoEUAddresses.BULGARIA_ADDRESS.region, MagentoEUAddresses.BULGARIA_ADDRESS.zip5, MagentoEUAddresses.BULGARIA_ADDRESS.city, MagentoEUAddresses.BULGARIA_ADDRESS.addressLine1);
        ...
        billingAddress = createBillingAddress(MagentoData.EU_SHIPPING_FIRST_NAME.data,
                MagentoData.EU_SHIPPING_LAST_NAME.data, MagentoEUAddresses.BULGARIA_ADDRESS.addressLine1,
                MagentoEUAddresses.BULGARIA_ADDRESS.country, MagentoEUAddresses.BULGARIA_ADDRESS.region,
                MagentoEUAddresses.BULGARIA_ADDRESS.city, MagentoEUAddresses.BULGARIA_ADDRESS.zip5,
    ...
    /**
     * CMAGM2-1147 Sales order Germany to Bulgaria
     */
    @Test(groups = {"magento_regression"})
    public void checkTaxAmountInCreateNewOrderEUBGTest( )
    {
    ...
    /**
     * CMAGM2-1149 Sales order US to Bulgaria
     */
    @Test(groups = {"magento_regression"})
    public void checkTaxAmountInCreateNewOrderUSBGTest( )
    {
