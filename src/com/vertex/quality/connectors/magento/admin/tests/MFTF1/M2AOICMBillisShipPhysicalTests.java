...
/**
 * tests tax on each stage of the order for a physical product
 * with same billing and shipping addresses
 *
 * @author alewis
 */
public class M2AOICMBillisShipPhysicalTests extends MagentoAdminBaseTest
{
	...
	protected M2AdminCustomersPage navigateToAllCustomers( )
	{
		...
		String customersPageTitle = customersPage.getPageTitle();

		assertTrue(customerTitleText.equals(customersPageTitle));
	...
	protected M2AdminCacheMgmt navigateToCacheManagement( )
	{
		...
		String cacheManagementTitle = cacheManagementPage.getPageTitle();

		assertTrue(cacheManagementTitleText.equals(cacheManagementTitle));
	...
	protected M2AdminProductsPage navigateToProducts( )
	{
		...
		assertTrue(productsPageTitleText.equals(productsPageTitle));
