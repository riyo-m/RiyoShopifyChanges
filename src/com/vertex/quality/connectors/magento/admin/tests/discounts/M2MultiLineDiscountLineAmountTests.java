 ...
 * @author vivek-kumar
 */
public class M2MultiLineDiscountLineAmountTests extends MagentoAdminBaseTest {
    ...
    public void checkCreateOrderDiscountTest() {
        ...
        newOrderPage = addMultipleLineProductDetails(MagentoData.TEN_DOLLAR_ITEM.data);
