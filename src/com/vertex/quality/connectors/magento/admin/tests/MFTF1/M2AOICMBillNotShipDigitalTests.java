...
/**
 * tests inputting a digital order, of which billing and shipping address are different
 *
 * @author alewis
 */
public class M2AOICMBillNotShipDigitalTests extends MagentoAdminBaseTest
{
	...
	{
		M2AdminOrderViewInfoPage infoPage = navigateOrderViewInfoPageToDigital();
	...
	public void checkBlindTaxesInOrderInfoPageOrderTotalsTest( )
	{
		...
		assertTrue(differenceString.equals(MagentoData.PA_TAX_NUMBER_2.data));
	...
	public void checkTaxInOrderInfoPageOrderTotalsTest( )
	{
		...
		assertTrue(differenceString.equals(MagentoData.PA_TAX_RATE_2.data));
	}
	...
	{
		M2AdminNewInvoicePage invoicePage = navigateToNewInvoicePageDigital();
	 ...
	 * @return Order View Info Page
	 */
	protected M2AdminOrderViewInfoPage navigateOrderViewInfoPageToDigital( )
	{
		M2AdminCreateNewOrderPage newOrderPage = navigateToOrderCustomerPage();
		newOrderPage.clickAddSKUButton();
	 ...
	 * @return Order View Info page
	 */
	protected M2AdminNewInvoicePage navigateToNewInvoicePageDigital( )
	{
		M2AdminOrderViewInfoPage newOrderPage = navigateOrderViewInfoPageToDigital();
		M2AdminNewInvoicePage invoicePage = newOrderPage.clickInvoiceButton();
	...
	/**
	 * Submits a credit memo for an invoice
	 */
