 ...
 * @author vivek-kumar
 */
public class M2SalesOrderShippingTermVirtualProductTests extends MagentoAdminBaseTest {
    ...
    /**
     * CMAGM2-1213 Test Case - Create Sale Order for VAT (Intra EU DE-DE) with product code exemption, virtual product and Shipping
     */
    ...
    public void checkTaxAmountInVirtualProductTest() {
        try {
            ...
            newOrderPage = addProductsAddressDetails(MagentoData.QA_EXEMPTED_VIRTUAL_PRODUCT.data, MagentoData.quantity_one.data);
            ...
            assertEquals(newOrderPage.getTaxFromUI(), newOrderPage.calculateIndividualPercentBasedTax(false, true, 19));
