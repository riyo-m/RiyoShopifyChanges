 ...
 * @author vivek-kumar
 */
public class M2MultiLineSalesOrderDiscountAmountTests extends MagentoAdminBaseTest {
    ...
    public void checkCreateOrderDiscountTest() {
        ...
        newOrderPage = addMultipleLineProductDetails(MagentoData.FIVE_DOLLAR_ORDER.data);
