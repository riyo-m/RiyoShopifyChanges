 ...
 * @author vivek-kumar
 */
public class M2SalesOrderShippingTermDDPVATTests extends MagentoAdminBaseTest {
    ...
    /**
     * tests tax on bottom right of page in Create New Order Page for Shipping Terms DDP VAT.
     * CMAGM2-952
     */
    ...
    public void checkTaxAmountInDDPVATTest() {
        try {
            ...
            billingAddress = createBillingAddress(MagentoData.EU_SHIPPING_FIRST_NAME.data,
                    MagentoData.EU_SHIPPING_LAST_NAME.data, Address.BerlinAlternate.addressLine1,
            ...
            shippingAddress = createShippingAddress(MagentoData.AT_BILLING_FIRST_NAME.data,
                    MagentoData.AT_BILLING_LAST_NAME.data, Address.BerlinAlternate.addressLine1,
                    Address.BerlinAlternate.country.fullName, Address.BerlinAlternate.city,
                    Address.BerlinAlternate.city, Address.BerlinAlternate.zip5,
