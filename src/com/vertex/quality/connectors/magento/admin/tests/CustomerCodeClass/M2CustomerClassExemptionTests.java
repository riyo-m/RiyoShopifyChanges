 ...
 * @author rohit-mogane
 */
public class M2CustomerClassExemptionTests extends MagentoAdminBaseTest {
    ...
    public void checkCustomerClassExemptionTest() {
        ...
        newOrderPage = addProductAddressDetailsForCustomerCodeClass(MagentoData.CUSTOMER_CLASS_CUSTOMER_NAME.data, MagentoData.quantity_one.data);
