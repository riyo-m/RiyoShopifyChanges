...
/**
 * tests inputting a physical product order for a Canadian customer, of which billing and shipping address are the same
 *
 * @author alewis
 */
public class M2AOICMBillisShipPhysicalCANTests extends MagentoAdminBaseTest
{
	...
	/**
	 * tests tax on top of page in Create New Order Page for Canada tax rate
	 */
	@Test()
	public void checkTaxInCreateNewOrderItemsOrderTest( )
	{
		...
		assertTrue(totalString.equals(MagentoData.CANADA_TAX_RATE.data));
	}

	/**
	 * tests tax on bottom right of page in Create New Order Page for Canada tax rate
	 */
	@Test()
	...
	public void checkSubtotalTaxInOrderInfoPageItemsOrderedTest( )
	{
		...
		assertTrue(differenceString.equals(MagentoData.CANADA_TAX_RATE.data));
	}

	/**
	 * tests tax in Items Ordered section of Order View Info page for Canada sales tax
	 */
	@Test()
	public void checkTaxInOrderInfoPageItemsOrderedTest( )
	{
		...
		assertTrue(percentTaxPaidString.equals(MagentoData.CANADA_TAX_NUMBER.data));
	}

	/**
	 * tests the tax percent 8765
	 * in Items Ordered section of Order View Info page for Canada sales tax is correct
	 *  `````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````
	 */
	@Test()
	public void checkTaxPercentInOrderInfoPageItemsOrderedTest( )
	{
		...
		String parseTaxAmount = taxPercent.replaceAll("%","");
		Double doubleTaxPercent = Double.valueOf(parseTaxAmount);
		Double taxValue = Math.ceil(doubleTaxPercent);
		String taxPercentString = Double.toString(taxValue);
		String taxPercentValue = taxPercentString.replaceAll(".0","%");

		assertTrue(taxPercentValue.equals(MagentoData.CANADA_TAX_PERCENT.data));
	}

	/**
	 * tests tax in Order Totals section of Order View Info page for Canada sales tax
	 */
	@Test()
	public void checkSubtotalTaxInOrderInfoPageOrderTotalsTest( )
	{
		...
		String taxValue = new  DecimalFormat("##.##").format(difference);

		assertTrue(taxValue.equals(MagentoData.CANADA_TAX_RATE.data));
	}
	...
	/**
	 * tests taxes in tax blind in Order Totals section of Order View Info page for Canada sales tax
	 */
	@Test()
	public void checkBlindTaxesInOrderInfoPageOrderTotalsTest( )
	{
		...
		String differenceString = new  DecimalFormat("#.##").format(correctSalesUsePercent);
		...
		assertTrue(differenceString.equals(MagentoData.CANADA_TAX_NUMBER.data));
		assertTrue(differenceShippingString.equals(MagentoData.CANADA_TAX_NUMBER.data));
	}
	...
	public void checkTaxInOrderInfoPageOrderTotalsTest( )
	{
		...
		double difference = doubleInclPrice / doubleExclPrice;
		String differenceString = new  DecimalFormat("#.##").format(difference);

		assertTrue(differenceString.equals(MagentoData.CANADA_TAX_RATE.data));
	}

	/**
	 * tests tax in Items to Invoice section of New Invoice page for Canada sales tax
	 */
	@Test()
	 ...
	 * in Items to Invoice section of New Invoice page for Canada sales tax
	 */
	@Test()
	...
	/**
	 * tests Subtotal tax in Invoice Totals section of New Invoice page for Canada sales tax
	 */
	@Test()
	...
	/**
	 * tests Shipping & Handling tax in Invoice Totals section of New Invoice page for Canada sales tax
	 */
	@Test()
	...
	/**
	 * tests tax in tax blind Invoice Totals section of New Invoice page for Canada sales tax
	 */
	@Test()
	...
	/**
	 * tests tax in Invoice Totals section of New Invoice page for Canada sales tax
	 */
	@Test()
	public void checkTaxInBlindInvoicePageInvoiceTotalsTest( )
	{
		...
		assertTrue(differenceString.equals(MagentoData.CANADA_TAX_NUMBER.data));
		assertTrue(shippingString.equals(MagentoData.CANADA_TAX_NUMBER.data));
	}

	/**
	 * Checks Subtotal of tax in Items to Refund section of New Memo page for Canada sales tax
	 */
	@Test()
	...
	/**
	 * checks for correct tax amount in Items to Refund section of New Memo page for Canada sales tax
	 */
	@Test()
	...
	/**
	 * test subtotal tax in Refund Totals section of New Memo page for Canada sales tax
	 */
	@Test()
	...
	/**
	 * test tax in Blind in Refund Totals section of New Memo page for Canada sales tax
	 */
	@Test()
	public void checkBlindTaxInMemoPageRefundTotalsSectionTest( )
	{
		...
		assertTrue(differenceString.equals(MagentoData.CANADA_TAX_RATE_2.data));
	}

	/**
	 * test tax in Refund Totals section of New Memo page for Canada sales tax
	 */
	@Test()
