 ...
 * Create Sale Order and Invoice with Shipping Terms EXW.
 *
 * @author vivek-kumar
 */
public class M2SalesOrderShippingTermEXWTests extends MagentoAdminBaseTest {
    ...
    /**
     * tests tax on bottom right of page in Create New Order Page for Shipping Term EXW.
     * CMAGM2-950
     */
