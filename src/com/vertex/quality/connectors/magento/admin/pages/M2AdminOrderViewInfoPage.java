...
public class M2AdminOrderViewInfoPage extends MagentoAdminPage
{
	...
	protected By orderInfoBillingAddress = By.xpath(".//div[@class='admin__page-section-item order-billing-address']//address");
	protected By orderInfoShippingAddress = By.xpath(".//div[@class='admin__page-section-item order-shipping-address']//address");
	...
	public String getBillingAddress() {
		...
		String address = text.getElementText(wait.waitForElementPresent(orderInfoBillingAddress));
	...
	public String getShippingAddress() {
		waitForPageLoad();
		waitForSpinnerToBeDisappeared();
		String address = text.getElementText(wait.waitForElementPresent(orderInfoShippingAddress));
		VertexLogger.log(address);
		return address;
	}
