...
import com.vertex.quality.connectors.saptaxservice.utils.SAPCFATaxServiceAPITestUtilities;
import com.vertex.quality.connectors.saptaxservice.utils.SAPTaxServiceAPITestUtilities;
import org.testng.annotations.Test;

/**
 * Base test for CFA SAP Tax Service
 * Used mainly to authenticate requests.
 *
 * @author unaqvi
 */
@Test(groups = { "sap_cfa_tax_service" })
public abstract class SAPCFATaxServiceBaseTest extends VertexAPIBaseTest
{
	protected SAPCFATaxServiceAPITestUtilities apiUtil;

	//don't modify this dynamically- its value is based on the value in the api test utility object
	protected String baseUrl;

	protected final DBConnectorNames connectorName = SAPCFATaxServiceAPITestUtilities.CONNECTOR_NAME;
	protected final DBEnvironmentNames environmentName = SAPCFATaxServiceAPITestUtilities.ENVIRONMENT_NAME;
	protected final DBEnvironmentDescriptors environmentDescriptor
		= SAPCFATaxServiceAPITestUtilities.ENVIRONMENT_DESCRIPTOR;
	...
	{
		this.apiUtil = new SAPCFATaxServiceAPITestUtilities();
