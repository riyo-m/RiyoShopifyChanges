 ...
 */
public class SitecoreSalesOrderTests extends SitecoreBaseTest
{
	...
	public void salesOrderTest( )
	{
		...
		int quantity = CommonDataProperties.DEFAULT_QUANTITY;

		// set billing address
		final String country = Address.Anaheim.country.fullName;
		...
		final String fullAddressStr = String.format("%s %s, %s , %s %s, %s", firstName, lastName, addressLine1, city,
			zip, Address.Anaheim.country.iso2code);
