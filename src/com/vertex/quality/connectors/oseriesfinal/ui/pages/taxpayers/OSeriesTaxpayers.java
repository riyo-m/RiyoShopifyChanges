...
import com.vertex.quality.connectors.oseriesfinal.api.tests.OSeriesFinalWebServicesTests;
...
public class OSeriesTaxpayers extends VertexPage {
    ...
    protected By saveButton = By.xpath(".//*[@id='saveTaxpayer_button']");
    protected By cancelButton = By.xpath(".//*[@id='cancelTaxpayer_button']");
    OSeriesFinalWebServicesTests oSeriesFinalWebServicesTests;
    ...
    public void editTaxPayer() {
        ...
        WebElement editTaxPayer = wait.waitForElementEnabled(showActionsEdit);
    ...
    public void saveSettings() {
        WebElement save = wait.waitForElementPresent(saveButton, 5);
    ...
    public void updateShippingTerms(boolean isSelect, String term) {
        oSeriesFinalWebServicesTests = new OSeriesFinalWebServicesTests();
        ...
        saveSettings();
        oSeriesFinalWebServicesTests.cacheRefreshTest();
    }
}
