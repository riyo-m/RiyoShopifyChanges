...
/**
 * CSA-872 :Create Sales Order with Invoice CANQC to CANBC different Province (GST/PST)
...
public class CommerceToolsAPICreateCANQCTOCANBCOrderTests extends CommerceToolAPITestUtilities {
    /**
    ...
    public void createOrderRequestTest()
	{
		...
		String streetName = "Store St Victoria", streetNumber = "1820", postal = "BC V8T 4R4", Shipping_City = "Quispamsis", Shipping_State = "", Shipping_Country = "CA";
