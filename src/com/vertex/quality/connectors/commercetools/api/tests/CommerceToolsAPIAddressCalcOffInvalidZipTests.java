...
/**
 * CSAPCT-228...Test Case - CCT- Address Cleansing Continue to Calc OFF with Invalid Zip - Administrative Origin
...
public class CommerceToolsAPIAddressCalcOffInvalidZipTests extends CommerceToolAPITestUtilities
{
	...
	public void addressCleansingCalcOffInvalidZipRequestTest( )
	{
		createDriver();
		CommerceToolsAddressCleanseTest();
		String streetAddress1 = "Hackworth Road apt 2", streetAddress2 = "2473", city = "Chester", mainDivision = "AL",
