...
public class CommerceToolsAPICreateUSEUVATOrderTests extends CommerceToolAPITestUtilities {
    ...
    public void createOrderUSEUVATRequestTest() {
		validateToken();
        ...
        try
		{
			...
			String streetName = "Port de la Bourdonnais", streetNumber = "75007", postal = "75007", Shipping_City = "Paris", Shipping_State = "", Shipping_Country = "FR";
