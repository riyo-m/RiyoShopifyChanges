...
public class CommerceToolsAPICreateUSTOCANOrderTests extends CommerceToolAPITestUtilities {
    ...
    public void createOrderUSCANRequestTest() {
        ...
        try
		{
			...
			String streetName = "Store St Victoria", streetNumber = "1820", postal = "BC V8T 4R4", Shipping_City = "", Shipping_State = "", Shipping_Country = "CA";
