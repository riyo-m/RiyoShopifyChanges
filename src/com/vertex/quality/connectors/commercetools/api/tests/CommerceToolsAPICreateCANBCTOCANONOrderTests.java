...
public class CommerceToolsAPICreateCANBCTOCANONOrderTests extends CommerceToolAPITestUtilities {

    /**
     * Test case for creating Sales order Invoice request.
     */
    @Test (groups = {"commercetools_api_regression"})
    public void createOrderCANBCOCRequestTest()
	{
		validateToken();

		String streetAddress1 = " Store St Victoria", streetAddress2 = "1820", mainDivision = "", city = "St Victoria",
			postalCode = "BC V8T 4R4", country = "CA";
		...
		String streetName = "Bank St ", streetNumber = "375", postal = "K2P 1Y2", Shipping_City = "Ottawa",
